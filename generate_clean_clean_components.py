...
# 1. SalesCustomerProfiles: lines 10123 to 10714
cust_inner = '\n'.join(lines[10122:10714])
...
# 2. SalesPackagesManager: lines 10715 to 11287
pkg_inner = '\n'.join(lines[10714:11287])
...
# 3. SalesLeadsTable: lines 11547 to 12224
table_inner = '\n'.join(lines[11546:12224])

# Apply Fix: Action Dropdown in Sales Leads Table
...
# 4. SalesCrmWizard: lines 11289 to 11545 (Create lead) AND 13179 to 14513 (Lead CRM)
w1_inner = '\n'.join(lines[11288:11545])
w2_inner = '\n'.join(lines[13178:14513])
...
""" + w1_inner + """
  ...
  if (selectedLead) {
    return (
      <div id="crm_lead_detail_wizard_container" className="bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden animate-fade-in flex flex-col text-slate-350">
""" + w2_inner + """
      </div>
    );
  }
...
# 5. SalesModals: lines 12604 to 13178 and 14515 to 15340
