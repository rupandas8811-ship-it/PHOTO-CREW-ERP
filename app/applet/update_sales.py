...
path = '/app/applet/src/components/SalesModule.tsx'
with open(path, 'r', encoding='utf-8') as f:
    content = f.read()

start_marker = '                            {(() => {\n                              const isManageCrmOnlyStatus ='
end_marker = '                            })()}\n                          </td>\n                        </tr>'
...
replacement = """                            {(() => {
                              ...
                              const leadOrderId = linkedOrder?.order_id || (lead as any).order_id || '';
                              ...
                              return (
                                <div className="relative inline-block text-left actions-dropdown-container">
                                  ...
                                  >
                                    <span>
                                      {isPendingUnlock ? '🟡 Action' : isApprovedUnlock ? '🟢 Action' : isRejectedUnlock ? '🔴 Action' : '⚡ Actions'}
                                    </span>
                                    ...
                                    >
                                      ...
                                      <button
                                        ...
                                        onClick={(e) => {
                                          ...
                                          setNoteModalOrderId(leadOrderId);
                                      ...
                                      >
                                        {isActiveInSales && canEdit && !isLeadLostStatus ? (
                                          <>
                                      ...
                                      {/* Unlock / Edit Quotation Options (when applicable) */}
                                      {isPendingUnlock ? (
                                        <button
                                          type="button"
                                          disabled
                                      ...
                                      ) : (lead.quotation_locked === true && isActiveInSales && canEdit) ? (
                                        <button
                                          type="button"
                                          onClick={(e) => {
                                            e.stopPropagation();
                                      ...
                                      {/* Confirm Order Option (when in Sales and status allows) */}
                                      {isActiveInSales && canEdit && !isLeadLostStatus && (
                                        <button
                                          type="button"
...
print('Updated SalesModule.tsx Action dropdown successfully!')
