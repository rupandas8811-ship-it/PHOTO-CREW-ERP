...
target = "const currentStage = prod?.editing_status || o.current_stage || 'Confirmed';"

replacement = "const currentStage = isClosed ? 'Order Closed' : (prod?.editing_status || o.current_stage || 'Confirmed');"
