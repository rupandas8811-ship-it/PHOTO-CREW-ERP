...
console.log(generateDeterministicAssignmentId("ORD1", "869f1321-4147", "Photographer", 1));
console.log(generateDeterministicAssignmentId("ORD1", "953c68ab-61b8", "Photographer", 1));
