            ...
            {canEdit ? (
              <form onSubmit={handleFollowUpSubmit} className="space-y-4">
                ...
                <div className="flex justify-end gap-2.5 pt-2">
                  ...
                  >
                    {isSaving ? 'Saving...' : (isLeadLocked ? '🔒 Locked' : isLeadConfirmed ? 'Save' : followUpForm.status === 'Order Confirmed' ? '💍 Confirm Order booking' : 'Save Follow-up Notes')}
                  </button>
                </div>
              </form>
            ) : (
                ...
                >
                  <div className="overflow-hidden">
                    <div className="bg-zinc-900/40 rounded-2xl border border-zinc-850 shadow-xl relative p-4">
                      ...
                      {/*
                        ⚠️ STUB CLOSURE — EVERYTHING BELOW THIS COMMENT WAS AUTO-GENERATED BY CLAUDE
                        TO MAKE THE FILE COMPILE. IT IS NOT YOUR ORIGINAL CODE.

                        Your original file was corrupted with binary data starting right after this point
                        (originally around line 11547 of the source, inside the Collapsible Quick Filters
                        Panel: a div with className="absolute ..." for corner calibration tick marks).
                        Everything from there to the end of the original file (~230 lines) was destroyed
                        and could not be recovered — that includes the rest of this Quick Filters panel,
                        anything that came after it in the component, and the component/function closing.

                        The lines just below simply close out the open tags/braces/parens so the file is
                        syntactically valid TSX and Vite/esbuild can build it. They add NO real UI, fields,
                        buttons, or logic — the corresponding section of your app will render EMPTY until
                        you restore the real content (from git history, a backup, or Vercel's last
                        successful deploy) and paste it in here, replacing this stub.
                      */}
