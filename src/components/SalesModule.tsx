        ...
        >
          <div>
            ...
            <p className="text-xs text-zinc-400 mt-1">
              Logged in as <strong className="text-white font-semibold">{loggedInSalesPersonName}</strong> — Collect potential inbound queries, log CRM call reports, propose quotations and confirm contracts.
            </p>
          </div>
          ...
          >
            ...
            <div className="flex justify-between items-center gap-3 border-t border-slate-800/80 py-2 px-4 sm:px-5 bg-slate-950/40 backdrop-blur-md shrink-0">
              ...
              {wizardStep < 3 ? (
                ...
                >
                  {isSaving ? 'Saving...' : (salesStatus === 'Order Confirmed' && !isLeadConfirmed) ? '🎉 Confirm Order & Transition' : '✍️ Create Quotation'}
                </button>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 mt-2">
            {[
              ...
              <CameraLensStatsCard
                ...
                onClick={() => setFilterStatus(filterStatus === card.filterValue ? '' : card.filterx�
K�)Mլ�R@�v(�(
l�S2�
иp�H�p��5W�5   �� �p�