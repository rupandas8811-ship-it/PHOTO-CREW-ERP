...
# 2. PackagesManager: lines 10647 to 11262 (0-indexed: 10646 to 11262)
pkg_inner = '\n'.join(lines[10646:11262])
...
# 3. SalesLeadsTable: lines 11547 to 12223 (0-indexed: 11546 to 12223)
table_inner = '\n'.join(lines[11546:12223])
...
# 4. SalesCrmWizard:
# create lead form is lines 11265 to 11544 (0-indexed: 11264 to 11544)
# lead crm modal is lines 13174 to 14513 (0-indexed: 13173 to 14513)
w1_inner = '\n'.join(lines[11264:11544])
w2_inner = '\n'.join(lines[13173:14513])
...
# 5. SalesModals: lines 12605 to 13172 (0-indexed: 12604 to 13172) AND lines 14518 to 15342 (0-indexed: 14517 to 15342)
m1_inner = '\n'.join(lines[12604:13172])
m2_inner = '\n'.join(lines[14517:15342])
